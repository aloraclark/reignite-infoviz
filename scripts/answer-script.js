...
function respondToUser() {
    ...
    var response = "";
    if (number == 7) {response = "You are correct! Keep scrolling to find out more!";}
    else if(number <= 3) {response = "Aww! Have a little more faith. Keep scrolling to find out the correct answer!";}
